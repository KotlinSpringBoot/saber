...
Legend entries appear in the same menuOrder as their series by default. If "sorted"
is "reverse" then they appear in the opposite menuOrder from their series. To sort
...
```js
sorted: function(a, b) {
    // sort alphabetically in ascending menuOrder
...
hooks in the plugins bundled with Flot.
 ...
 - bindEvents  [phase 6]
    ...
    menuOrder wrong. The hook only gets one event, though (either for the
...
(make sure you get the menuOrder right), then optionally run it through a
